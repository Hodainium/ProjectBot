...
FString FHVerbMessage::ToString() const
{
	...
	FHVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
	return HumanReadableMessage;
}

APlayerState* UHVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UHVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UHVerbMessageHelpers::VerbMessageToCueParameters(const FHVerbMessage& Message)
{
...
FHVerbMessage UHVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FHVerbMessage Result;
