...
class HEREWEGO_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UHIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UHIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UHIndicatorManagerComponent> ManagerPtr;
