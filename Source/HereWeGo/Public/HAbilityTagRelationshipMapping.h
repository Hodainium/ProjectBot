...
#include "HAbilityTagRelationshipMapping.generated.h"

USTRUCT()
struct FHAbilityTagRelationship
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class HEREWEGO_API UHAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FHAbilityTagRelationship> AbilityTagRelationships;
