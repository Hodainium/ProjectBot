...
#include "HCharacterBaseOld.generated.h"
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnCharacterDeathDelegate, AHCharacterBaseOld*, Character);

UCLASS()
class HEREWEGO_API AHCharacterBaseOld : public AModularCharacter, public IAbilitySystemInterface, public IHInventoryInterface, public IHWeaponInterface
{
	GENERATED_BODY()

public:
	// Sets default values for this character's properties
	AHCharacterBaseOld(const FObjectInitializer& ObjectInitializer);
