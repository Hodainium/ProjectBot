...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_ABILITY_ACTIVATE_FAIL_ACTIVATION_GROUP);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_ABILITY_ACTIVATE_FAIL_DEATH);
 ...
 */
UCLASS(Abstract)
class HEREWEGO_API UHGameplayAbility : public UGameplayAbility
{
	GENERATED_BODY()
...
public:
	UHGameplayAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
