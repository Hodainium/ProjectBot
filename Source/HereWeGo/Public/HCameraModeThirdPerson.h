...
#include "HPenetrationAvoidanceFeeler.h"
#include "HCameraModeThirdPerson.generated.h"
...
class HEREWEGO_API UHCameraModeThirdPerson : public UHCameraMode
{
	GENERATED_BODY()

public:

	UHCameraModeThirdPerson();
...
public:
	...
	TArray<FHPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
