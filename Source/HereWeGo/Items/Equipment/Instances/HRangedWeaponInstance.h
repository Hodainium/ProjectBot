...
#include "HRangedWeaponInstance.generated.h"

/**
 *
 */
UCLASS()
class HEREWEGO_API UHRangedWeaponInstance : public UHModifiedWeaponInstance, public IHAbilitySourceInterface
{
	GENERATED_BODY()

public:
	UHRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
