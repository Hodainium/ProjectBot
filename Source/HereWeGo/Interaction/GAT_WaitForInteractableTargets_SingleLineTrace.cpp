...
#include "GAT_WaitForInteractableTargets_SingleLineTrace.h"
#include "InteractionStatics.h"


#include UE_INLINE_GENERATED_CPP_BY_NAME(GAT_WaitForInteractableTargets_SingleLineTrace)

UGAT_WaitForInteractableTargets_SingleLineTrace::UGAT_WaitForInteractableTargets_SingleLineTrace(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

UGAT_WaitForInteractableTargets_SingleLineTrace* UGAT_WaitForInteractableTargets_SingleLineTrace::WaitForInteractableTargets_SingleLineTrace(UGameplayAbility* OwningAbility, FInteractionQuery InteractionQuery, FCollisionProfileName TraceProfile, FGameplayAbilityTargetingLocationInfo StartLocation, float InteractionScanRange, float InteractionScanRate, bool bShowDebug)
{
	UGAT_WaitForInteractableTargets_SingleLineTrace* MyObj = NewAbilityTask<UGAT_WaitForInteractableTargets_SingleLineTrace>(OwningAbility);
...
void UGAT_WaitForInteractableTargets_SingleLineTrace::Activate()
{
	SetWaitingOnAvatar();
...
void UGAT_WaitForInteractableTargets_SingleLineTrace::OnDestroy(bool AbilityEnded)
{
...
void UGAT_WaitForInteractableTargets_SingleLineTrace::PerformTrace()
{
	...
	FCollisionQueryParams Params(SCENE_QUERY_STAT(UGAT_WaitForInteractableTargets_SingleLineTrace), bTraceComplex);
